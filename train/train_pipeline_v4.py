...
def compute_attn_supervise_loss(attentions, factor, max_top, max_oth, maskout):
...
if __name__ == '__main__':
    ...
    for step, batch in tqdm(enumerate(loader), disable=True):
        ...
        outputs = model(**batch)
        loss = compute_attn_supervise_loss(outputs.attentions, factor, args.max_top, args.max_oth, args.maskout) / accum_grad
        loss.backward() 
